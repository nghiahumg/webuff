...
<head>
    ...
    <link rel="stylesheet" href="/assets/themes/landing-font-end-5/css/animate.css?<?= rand(1, 999999999); ?>">
    <link rel="stylesheet" href="/assets/themes/landing-font-end-5/css/bootstrap.min.css?<?= rand(1, 999999999); ?>">
    <link rel="stylesheet" href="/assets/themes/landing-font-end-5/css/magnific-popup.css?<?= rand(1, 999999999); ?>">
    <link rel="stylesheet" href="/assets/themes/landing-font-end-5/css/owl.carousel.min.css?<?= rand(1, 999999999); ?>">
    <link rel="stylesheet" href="/assets/themes/landing-font-end-5/css/font-awesome.min.css?<?= rand(1, 999999999); ?>">
    <link rel="stylesheet" href="/assets/themes/landing-font-end-5/css/flaticon.css?<?= rand(1, 999999999); ?>">
    <link rel="stylesheet" href="/assets/themes/landing-font-end-5/css/hover-min.css?<?= rand(1, 999999999); ?>">
    <link rel="stylesheet" href="/assets/themes/landing-font-end-5/css/style.css?<?= rand(1, 999999999); ?>">
    <link rel="stylesheet" href="/assets/themes/landing-font-end-5/css/responsive.css?<?= rand(1, 999999999); ?>">
    <style>
        .page_speed_392861669 {
            background-image: url(/assets/themes/landing-font-end-5/img/bg.png);
        }

        .page_speed_1388071015 {
            background-image: url(/assets/themes/landing-font-end-5/img/01.png);
        }

        .page_speed_207883135 {
            background-image: url(/assets/themes/landing-font-end-5/bg.png);
        }

        .page_speed_2095747978 {
            background-image: url(/assets/themes/landing-font-end-5/01.png);
        }
    </style>
</head>
<style>
...
<body>
                ...
                <div class="collapse navbar-collapse" id="bizcoxx_main_menu">
                    <ul class="navbar-nav">
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="<?= $NTD->site('facebook'); ?>">Facebook</a>
                                </li>
                                <li><a href="#"><?= $NTD->site('facebook'); ?></a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-price-plan-02 wow animate__animated animate__fadeInUp animated">
                        ...
                        <div class="price-wrap">
                            <span class="price"><?= number_format($NTD->site('rate_ctv')) ?><sup>đ</sup></span>
                        </div>
                        <div class="price-body">
                            <ul>
                ...
                <div class="col-lg-3 col-md-12">
                    <div class="single-price-plan-02 wow animate__animated animate__fadeInUp animated">
                        ...
                        <div class="price-wrap">
                            <span class="price"><?= number_format($NTD->site('rate_daily')) ?><sup>đ</sup></span>
                        </div>
                        <div class="price-body">
                            <ul>
                ...
                <div class="col-lg-3 col-md-12">
                    <div class="single-price-plan-02 wow animate__animated animate__fadeInUp animated">
                        ...
                        <div class="price-wrap">
                            <span class="price"><?= number_format($NTD->site('rate_admin')) ?><sup>đ</sup></span>
                        </div>
                        <div class="price-body">
                            <ul>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-area-inner">
                            © 2022 <a href="/home"><?= $NTD->site('ten_website'); ?> | All rights reserved.</a>.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="/assets/themes/landing-font-end-5/js/jquery-2.2.4.min.js"></script>
    <script src="/assets/themes/landing-font-end-5/js/bootstrap.min.js"></script>
    <script src="/assets/themes/landing-font-end-5/js/jquery.magnific-popup.js"></script>
    <script src="/assets/themes/landing-font-end-5/js/wow.min.js"></script>
    <script src="/assets/themes/landing-font-end-5/js/owl.carousel.min.js"></script>
    <script src="/assets/themes/landing-font-end-5/js/waypoints.min.js"></script>
    <script src="/assets/themes/landing-font-end-5/js/jquery.counterup.min.js"></script>
    <script src="/assets/themes/landing-font-end-5/js/jquery.ripples-min.js"></script>

    <script src="/assets/themes/landing-font-end-5/js/tilt.jquery.js"></script>
    <script src="/assets/themes/landing-font-end-5/js/imagesloaded.pkgd.min.js"></script>
    <script src="/assets/themes/landing-font-end-5/js/isotope.pkgd.min.js"></script>
    <script src="/assets/themes/landing-font-end-5/js/parallax.js"></script>
    <script src="/assets/themes/landing-font-end-5/js/main.js"></script>
</body>
