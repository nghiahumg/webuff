...
<option value="5">Themes Login 5</option>
...
<option value="<?=$NTD->site('color_web');?>"><?php if($NTD->site('color_web')==""){?> Màu Tùy Chỉnh <?php }else{ ?> Dark Web <?php }?>   </option>
