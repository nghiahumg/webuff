                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input  type="text" rows="5" cols="50" class="form-control" name="so_du_tao_site" value="<?=$NTD->site('so_du_tao_site')?>" placeholder=" Nhập tên chủ tài khoản"></input>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <center><label class="form-label" for="">Tổng Tiêu</label></center>
                                                <input  type="text" rows="5" cols="50" class="form-control" name="so_tieu_tao_site" value="<?=$NTD->site('so_tieu_tao_site')?>" placeholder=" Nhập số tài khoản"></input>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
...
<?php
if($NTD->site('cap_bac_tao_site')==0){
$cap_bac_tao="Thành Viên";    
}
elseif($NTD->site('cap_bac_tao_site')==1){
$cap_bac_tao="Cộng Tác Viên";    
}
elseif($NTD->site('cap_bac_tao_site')==2){
$cap_bac_tao="Đại Lý";    
}
elseif($NTD->site('cap_bac_tao_site')==3){
$cap_bac_tao="Nhà Phân Phối";    
}
?>

<option value="<?=$NTD->site('cap_bac_tao_site')?>"><?=$cap_bac_tao;?></option>
...
<option value="3">Nhà Phân Phối</option>
                                        ...
                                        <div class="col-md-4 mr-auto ml-auto pt-3">
                                            <button type="submit" class="btn btn-primary btn-block">Cập Nhật <em class="fa fa-paper-plane"></em></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                        ...
                                        <table class="table table-bordered table-striped fs--1 mb-3 dataTables-NTD dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                            <thead class="bg-200 text-900">
                                                <tr role="row" history>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="type order: activate to sort column ascending" style="width: 193.031px;">Tên Website</th>
                                                      <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Trạng thái: activate to sort column ascending" style="width: 211.047px;">Tên Website Mẹ</th> 
                                                 
                                                  
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Server: activate to sort column ascending" style="width: 148.969px;">Thời Gian</th>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Trạng thái: activate to sort column ascending" style="width: 211.047px;">IP</th>
                                            ...
                                            <tbody>
                                               ...
                                               if($url_site_name==$URL_ADMIN){
                                                $getlistcard = $NTD->get_list("SELECT * FROM `ds_sitecon`  ORDER BY `id_site` DESC ");
                                               }else{
                                                    $getlistcard = $NTD->get_list("SELECT * FROM `ds_sitecon` WHERE  `url_config` = '".$url_site_name."' ORDER BY `id_site` DESC ");
                                               }
                                                if($getlistcard){ foreach($getlistcard as $rowucard){?>
                                                <tr class="odd">
