                                        ...
                                        <table class="table table-bordered table-striped fs--1 mb-3 dataTables-NTD dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                            ...
                                            <tbody>
                                                ...
                                                if($url_site_name==$URL_ADMIN){
                                                   $getlistcard = $NTD->get_list("SELECT * FROM `users` ORDER BY `id` DESC "); 
                                                }else{
                                                    $getlistcard = $NTD->get_list("SELECT * FROM `users`  WHERE `url_config` = '".$url_site_name."' ORDER BY `id` DESC ");  
                                                }
                                    ...
                                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
                                        <table class="table table-bordered table-striped fs--1 mb-3 dataTables-NTD dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                            ...
                                            <tbody>
                                                <?php 
                                                 if($url_site_name==$URL_ADMIN){
                                                  $getlistcard = $NTD->get_list("SELECT * FROM `log_site` ");
                                                }else{
                                                   $getlistcard = $NTD->get_list("SELECT * FROM `log_site` WHERE `url_config` = '".$url_site_name."'");
                                                   
                                                }
                                                 if($getlistcard){ foreach($getlistcard as $rowucard){?>
                                                <tr class="odd">
                                                    <td><?=$rowucard['id']?></td><td><?=$rowucard['username']?></td>
                                                    <td><?=$rowucard['note']?></td>
                                                    <td><?=$rowucard['ip']?></td>
                                                    <td><?=$rowucard['date']?></td>
                                                </tr>
