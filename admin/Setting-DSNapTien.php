                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive scrollbar">
                                    ...
                                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
                                        ...
                                        <tbody>
                                                <?php $getlistcard = $NTD->get_list("SELECT * FROM `history_naptien` WHERE `type` = 'Bank'  AND  `url_config` = '".$url_site_name."' ORDER BY `id` DESC "); if($getlistcard){ foreach($getlistcard as $rowucard){?>
                                                <tr class="odd">
                                                    <td><?=$rowucard['id']?></td>
                                                    <td><?=$rowucard['date']?>
                                ...
                                <div class="table-responsive scrollbar">
                                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
                                        <table class="table table-bordered table-striped fs--1 mb-3 dataTables-NTD dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                            ...
                                            <tbody>
                                                <?php
                                                $getlistcard = $NTD->get_list("SELECT * FROM `history_naptien` WHERE `type` = 'napthe'  AND  `url_config` = '".$url_site_name."' ORDER BY `id` DESC "); if($getlistcard){ foreach($getlistcard as $rowucard){?>
                                                <tr class="odd">
                                                    <td><?=$rowucard['id']?></td>
                                                    <td><?=$rowucard['loaithe']?></td>
