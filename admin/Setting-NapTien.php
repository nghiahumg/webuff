                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?=$NTD->site('cuphap');?>" name="cuphapnap" placeholder="Nhập cú pháp nạp tiền">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">Partner ID (nếu có):</label>
