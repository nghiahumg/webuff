                                ...
                                <h6 class="card-title mb-3">Danh sách hỗ trợ</h6>
                                  <div class="table-responsive scrollbar">
                                    ...
                                    <table class="table table-striped table-bordered mt-4 dataTables-NTD dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                        ...
                                        <tbody>
                                            <?php $getlistbuff = $NTD->get_list("SELECT * FROM `list_hotro` WHERE   `url_config` = '".$url_site_name."'
 ORDER BY `id` DESC "); if($getlistbuff){ foreach($getlistbuff as $rowhbuff){?>
                                            <tr class="odd">
                                                <td><?=$rowhbuff['id']?></td>
                                                <td><?=$rowhbuff['date']?></td>
                                              ...
                                              <b><a  href="/admin/sua_ho_tro.php?id=<?=$rowhbuff['id']?>&loai_ho_tro=<?=$rowhbuff['loai_hotro']?>" type="button" class="btn btn-warning btn-sm">Xử Lý Ngay</a></b>
                                               <?php }else{?>
