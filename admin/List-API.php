                                ...
                                <div class="table-responsive scrollbar">
                                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
                                        <table class="table table-bordered table-striped fs--1 mb-3 dataTables-NTD dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                            ...
                                            <tbody>
                                                <?php $getlist_api = $NTD->get_list("SELECT * FROM `list_api` WHERE  `url_config` = '".$url_site_name."' "); if($getlist_api){ foreach($getlist_api as $row_API){?>
                                                <tr class="odd">
                                                   <td><?=$row_API['id']?></td>
                                                <td><?=$row_API['date']?></td>
                                              ...
                                              <b><button type="button" class="btn btn-warning btn-sm">Đang Chờ</button></b>
                                               <?php }elseif($row_API['status']=="block"){?>
                                                ...
                                                <?php }?>
                                                    ...
                                                    <td><b>
                                                          <form submit-ajax="NTD" action="<?=BASE_URL('api/them-api');?>" method="post" api_token="<?=$NTD->getUsers('token');?>">
