                                    ...
                                    <div class="row">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input  type="text" value="<?=$NTD->site('anh_thong_bao');?>" class="form-control" name="anh_thong_bao">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <center><label class="form-label" for="">Nhập thông báo nổi</label></center>
                                                <input  type="text" value="<?=$NTD->site('thongbao');?>" class="form-control" name="thongbao_noi">
                                            </div>
                                        </div>
                                            <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control show-tick" name="thong_bao_mail" required=""> <option value="<?=$NTD->site('thong_bao_mail');?>"><?=$NTD->site('thong_bao_mail');?></option> <option value="ON">ON</option> <option value="OFF">OFF</option> </select>
                                ...
                                <div class="table-responsive scrollbar">
                                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
                                        <table class="table table-bordered table-striped fs--1 mb-3 dataTables-NTD dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                            ...
                                            <tbody>
                                                <?php $getlistcard = $NTD->get_list("SELECT * FROM `note_thongbao` WHERE `nguoidang` = '$my_user'  AND  `url_config` = '".$url_site_name."' ORDER BY `id` DESC "); if($getlistcard){ foreach($getlistcard as $rowucard){?>
                                                <tr class="odd">
                                                    <td><?=$rowucard['id']?></td>
