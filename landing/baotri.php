<!DOCTYPE html>
<?php require('../config/function.php');if($NTD->site('bao_tri')=="ON"){
...
<body>
            ...
            <div class="container">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="about-us item">
                        ...
                        <!-- section text -->
                        <div class="row">
                          <div class="col-md-4"> <div class="card"><br><div class="card-body pb-5"> <div class="pt-4 pb-5"> <img src="https://img.icons8.com/dusk/452/facebook--v1.png" class="img-fluid img-center" width="50px" alt="Illustration"> </div> <h5 class="h4 lh-130 mb-3"><center></center></h5> <p class="text-muted mb-0">Chuyên cung cấp các dịch vụ tăng Like Facebook, Share, Comment, Follow Chất Lượng...</p><br> </div> </div> </div><br>
                          <div class="col-md-4"> 
                          <div class="card"> <br><div class="card-body pb-5"> <div class="pt-4 pb-5"> <img src="https://img.icons8.com/color/452/instagram-new--v1.png" class="img-fluid img-center" width="50px" alt="Illustration"> </div> <h5 class="h4 lh-130 mb-3"><center>Instagram</center></h5> <p class="text-muted mb-0">Mang lại cho người dùng mội lượng tương tác thật, giúp tăng sự nổi tiếng của bạn.</p> <br></div> </div> </div>
                          <br>
                          <div class="col-md-4"> 
                          <div class="card"> <br><div class="card-body pb-5"> <div class="pt-4 pb-5"> <img src="https://img.icons8.com/ios-filled/452/tiktok--v1.png" class="img-fluid img-center" width="50px" alt="Illustration"> </div> <h5 class="h4 lh-130 mb-3"><center>TikTok</center></h5> <p class="text-muted mb-0">Tăng Tim, Follow, Comment một cách hiệu quả, giúp bạn có nhiều sự phát triển hơn.</p> <br></div> </div> </div>
                        </div>
        ...
        <div class="row justify-content-center text-center">
            <div class="col-lg-12">
              ...
              <div class="">
                  ...
                  <a href="<?=$NTD->site('facebook');?>"><img src="https://img.icons8.com/fluency/452/facebook-new.png" width="50px"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <a href="https://zalo.me/<?=$NTD->site('phone_zalo');?>"><img src="https://img.icons8.com/color/452/zalo.png" width="50px"></a>
              </div>
 ...
 <br> <br>
    <form novalidate="" role="form" action="" method="POST">
     ...
     <br>
        <div class="mb-3"><center><button class="btn btn-primary d-block w-100 mt-3" type="submit" name="login" id="log" onclick="log()">Đăng Nhập</button></center></div><br>
    </form>
    <?php
               ...
               echo '<script type="text/javascript">swal("Thất Bại", "Nhập tài khoản hợp lệ", "error");</script>';
                ...
                if(!$NTD->get_row(" SELECT * FROM `users` WHERE `username` = '".check_string($_POST['username'])."' AND  `url_config` = '".$url_site_name."' "))
                {
                    ...
                    if(!$checkuseriui)
                    {
                        ...
                        if($NTD->get_row(" SELECT * FROM `users` WHERE `username` = '".check_string($_POST['username'])."' AND `banned` > '1' ")){
