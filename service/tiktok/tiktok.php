<?php require('../../config/function.php');$text=getCurURL();$dichvu1=(explode('/', $text));$dich_vu=$dichvu1['5'];if($dich_vu=="cmt"){$dtb="cmt_tiktok"; $action=$dichvu1['5']; $title="Tăng Comment";}elseif($dich_vu=="like"){$dtb="like_tiktok"; $action=$dichvu1['5']; $title="Like Video TikTok";}elseif($dich_vu=="follow"){$dtb="sub_tiktok"; $action=$dichvu1['5']; $title="Follow TikTok";}

elseif($dich_vu=="view"){$dtb="view_tiktok"; $action=$dichvu1['5']; $title="View Video TikTok";}
elseif($dich_vu=="share"){$dtb="share_tiktok"; $action=$dichvu1['5']; $title="Share TikTok";}
...
<div class="col-md-8 mb-3">
   <form submit-ajax="NTD" action="<?=BASE_URL('api/tiktok/buy');?>" method="post" api_token="<?=$NTD->getUsers('token');?>">
