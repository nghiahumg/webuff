...
if($dich_vu=="cmt"){$dtb="cmt"; $action="cmt"; $title="Bình Luận Nhanh";}
if($dich_vu=="cmt-sale"){$dtb="cmt_sale"; $action="cmt-sale"; $title="Bình Luận Giảm Giá";}
...
<?php if($action=="cmt"){?><label for="" class="form-label col-md-3">ID bài viết </label><?php }else{?><label for="" class="form-label col-md-3">Link bài viết </label><?php }?>
<div class="col-md-9">
<input class="form-control" name="id"  <?php if($action=="cmt"){?>placeholder="Nhập id bài viết hoặc nhập link" onpaste="getUID('id');"<?php }else{?> type="url" placeholder="Nhập link link cần tăng"<?php }?>  onchange="bill();">
...
<div class="col-md-9">
<input type="text" class="form-control mb-3" name="soluong"  onchange="bill();" value="50" placeholder="Nhập số lượng cần tăng">
...
- <b>Mua bằng ID bài viết đã mở chế độ công khai.</b> <br>
- <b>Tăng bài viết của group thì group phải công khai và object_id phải là dạng
idgroup_idpost, ví dụ: 53489350092255_53684602739369 (chỉ hỗ trợ cho sv1, sv2)</b>
</div> </div>
</div>
<div class="form-group row mb-3">
