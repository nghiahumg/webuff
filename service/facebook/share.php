...
if($dich_vu=="share"){
$dtb="share"; $action="share"; $title="Share Facebook Profile";}
...
<div class="col-md-9">
<input class="form-control" name="id"  placeholder="Nhập id bài viết hoặc link"  onchange="getUID('id');">
...
<? if($action=="share-sale"){?>
<div class="form-group row mb-3">
<label for="" class="form-label col-md-3">Bình luận </label>
<div class="col-md-9">
<textarea class="form-control" name="list_msg" rows="3" placeholder="Nhập nội dung chia sẻ, hashtag, mỗi nội dung 1 dòng"></textarea>
</div>
</div>
<?php }?>
<div class="form-group row mb-3">
