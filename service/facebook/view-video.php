<?php require('../../config/function.php'); $dtb="view_video"; $action="view-video"; $title="View Video";?><?php require('../../config/head.php'); if(empty($_SESSION['username'])){header('Location: /Login');exit;}else{$getrate=$NTD->get_list("SELECT * FROM `server_service` WHERE `code_service`='$dtb' AND `status_service`='1' AND `url_config`='".$url_site_name."' ");}?>
...
<div class="col-md-9">
<input class="form-control" name="id"  placeholder="Nhập link video"  onchange="bill();">
...
<div class="mb-1">
<div class="form-check">
<input class="form-check-input" id="time3" type="radio" name="speed" onchange="bill();" value="3">
...
<div class="mb-1">
<div class="form-check">
<input class="form-check-input" id="time10" type="radio" name="speed" onchange="bill();" value="10">
<label class="form-check-label" for="time10">Xem video trong 10
giây</label>
</div>
</div>
<div class="mb-1">
<div class="form-check">
<input class="form-check-input" id="time15" type="radio" name="speed" onchange="bill();" value="15" checked="">
<label class="form-check-label" for="time15">Xem video trong 15
giây</label>
</div>
</div>
</div>
...
<div class="alert bg-danger text-white" role="alert">
    ...
    - <b>Mua bằng link bài viết ở chế độ công khai</b>.<br>
                - <b>Chọn loại nào thì thời hạn video phải dài hơn thời chọn, vd: chọn 3s thì video
                    phải dài tối tiểu 4s</b>.
</div> </div>
</div>
<div class="form-group row mb-3">
