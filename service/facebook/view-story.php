<?php require('../../config/function.php'); $dtb="view_story"; $action="view-story"; $title="View Story";?><?php require('../../config/head.php'); if(empty($_SESSION['username'])){header('Location: /Login');exit;}else{$getrate=$NTD->get_list("SELECT * FROM `server_service` WHERE `code_service`='$dtb' AND `status_service`='1' AND `url_config`='".$url_site_name."' ");}?>
...
<label for="" class="form-label col-md-3">Link story </label>
<div class="col-md-9">
<input type="url" class="form-control" name="id" placeholder="Nhập link story cần tăng">
<small class="form-text text-muted">Lưu ý: hãy xem cách lấy link story chuẩn: <a href="https://imgur.com/0DXPYsc" target="_blank" class="font-bold">
Tại đây</a></small>
</div>
</div>
<div class="form-group row mb-3">
...
<div class="col-md-9">
<input type="text" class="form-control mb-3" name="soluong"  onchange="bill();" value="1000" placeholder="Nhập số lượng cần tăng">
...
<div class="alert bg-danger text-white" role="alert">
    ...
    - <b>Mua bằng link story phải mở chế độ công khai</b>.
</div>
