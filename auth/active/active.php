...
");
        ...
        $status_site = $NTD->get_row(" SELECT * FROM `ds_sitecon` WHERE `site_con` = '" . $url_site_name . "'
");
        $name_admin_site = $NTD->get_row(" SELECT * FROM `users` WHERE `token` = '" . $key_active . "' AND `url_config` = '" . $status_site['site_me'] . "'
");
        $ip_khach = getip();
