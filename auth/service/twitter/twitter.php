...
if ( $_SERVER['REQUEST_METHOD'] == 'GET' && realpath(__FILE__) == realpath( $_SERVER['SCRIPT_FILENAME'] ) ) {
 ...
 if($action=="like"){
    $link_post="api/service/twitter/like/order";
    
}
elseif($action=="sub"){
    $link_post="api/service/twitter/sub/order";
}
...
$url_post="https://$mien_site_me_thuong/auth/service/twitter/site_con.php?id=$id&soluong=$soluong&server=$server_buy&code_dich_vu=$code_dich_vu&action=$action&loai_camxuc=$loai_camxuc&time_buy=$time_buy&list_msg=$list_msg&domain_site_con=$mien_site_con&domain_site_me=$mien_site_me";
$ch = curl_init(); 
