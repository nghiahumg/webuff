...
$url_get="https://$mien_site_me_thuong/auth/service/instagram/site_con.php?id=$id&soluong=$soluong&server=$server_buy&code_dich_vu=$code_dich_vu&action=$action&loai_camxuc=$loai_camxuc&time_buy=$time_buy&list_msg=$list_msg&domain_site_con=$dm_site_con&domain_site_me=$dm_site_me";
$ch = curl_init(); 
