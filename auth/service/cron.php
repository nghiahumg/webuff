...
echo $don = get_don($link_post, 'FbLikePostSale_DBFK7V5TN0VK', $token_auto_dvfb, $URL_ADMIN);

$json = json_decode($don);

$buff = $json->data->buff;

echo $NTD->update("history_buy", ['buff' => $buff], "`ma_gd` = 'FbLikePostSale_3Z89JY7AAMSL'");