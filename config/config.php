...
define('USERNAME','btshxuct_testweb');
define('PASSWORD','btshxuct_testweb');
define('DATABASE','btshxuct_testweb');
...
{ 
    $NTD = new NTD;
    $getUser = $NTD->get_row(" SELECT * FROM users WHERE username = '".$_SESSION['username']."'  AND  `url_config` = '".strtoupper($_SERVER['SERVER_NAME'])."'");
    $my_username = 'True';
     $id  = $getUser['id'];
